...
Com-pare is a Filipino worker companion app for Singapore-based OFWs to track MOM work permit validity, OWWA membership, PhilHealth contributions, and personal finances — with a paid subscription tier from day one.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238495716+Alfred0-AO@users.noreply.github.com"
  git config user.name "Alfred0-AO"
  ```
